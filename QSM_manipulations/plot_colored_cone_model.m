function plot_colored_cone_model(cylinder,fig,nf,alp,Ind)
%Ind=1:length(cylinder);
...
%patch('Vertices',Vert,'Faces',Facets,'FaceVertexCData',fvd,'FaceColor','white')
color1=brewermap(8,'Dark2');
patch('Vertices',Vert,'Faces',Facets,'FaceVertexCData',fvd,'FaceColor',color1(8,:))
alpha(alp)
axis equal
grid on
view(-37.5,30)
...
%patch('Vertices',Vert,'Faces',Facets,'FaceVertexCData',fvd,'FaceColor',colors)